...
key_map("n", "ff", "<cmd>Telescope find_files<cr>", {})
key_map("n", "fg", "<cmd>Telescope live_grep<cr>", {})
key_map("v", "fb", "<cmd>Telescope buffers<cr>", {})
key_map("v", "fh", "<cmd>Telescope help_tags<cr>", {})
